  ...
  return (
    <View className={`space-y-2 ${otherStyles}`}>
      ...
      <View className="w-full h-16 bg-black-100 px-4 border-2 border-black-200 rounded-2xl focus:border-secondary flex-row items-center">
        <TextInput className="flex-1 w-full text-white font-psemibold text-base" placeholderTextColor="#7b7b8b" value={value} onChangeText={handleChangeInput} secureTextEntry={title === "Pasword" && !showPassword} />
